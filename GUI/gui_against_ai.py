...
from tensorflow_model.ai_player import model_column
...
class GUI:
    ...
    def __init__(self, master, user_first=True):
        self.master = master
    ...
    def _canvasClick(self, event):
        ...
        # model drops token
        model_choice = model_column(deepcopy(self.game.grid))
        self.drop(model_choice)
        self.draw()
        self._updateCurrentPlayer()
